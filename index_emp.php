        ...
        <!-- *** Informações do Usuário *** -->
            ...
            <br><br>
                ...
                <ul class="itensMenuLateral">
                    ...
                    <li class="item">
                        <a href="tab_perfil_emp.php" target="frameMain">
                            <i class="fa-solid fa-user-group"></i>
                            <span class="descricaoItem">Empresa</span>
                        </a>
                    </li>

                    <li class="item">
                        <a href="tab_perfil_colab.php" target="frameMain">
                            <i class="fa-solid fa-user-group"></i>
                            <span class="descricaoItem">Colaborador</span>
                        </a>
                    </li>
