...
$query = "SELECT nome, email FROM sispointer WHERE cpf = ?";
            ...
            <br><br>
                ...
                <ul class="itensMenuLateral">
                    <li class="item">
                        ...
                        <a href="tab_emp.php" target="frameMain">
                            <i class="fa-solid fa-building"></i>
                            <span class="descricaoItem">Empresas</span>
                        </a>
                    </li>

                    <li class="item">
                        <a href="tab_colab.php" target="frameMain">
                            <i class="fa-solid fa-user-group"></i>
                            <span class="descricaoItem">Colaboradores</span>
                        </a>
                    </li>
                        
                    <li class="item">
                        <a href="relatorio.php" target="frameMain">
